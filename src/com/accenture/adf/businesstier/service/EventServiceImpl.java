...
public class EventServiceImpl implements EventFacade {
	...
	public List<Event> getAllEvents() {
		...
		return event; // This return value will vary depending on the coding based on Todos above. It may be ArrayList<Event[]>  
	}
	...
	public boolean checkEventsofVisitor(Visitor visitor, int eventid) {
		...
		// TODO:  For more comprehensive pseudo-code with details, refer to the Component/Class Detailed Design Document
				...
				boolean check=false;
				try {
				   check=edao.checkEventsofVisitor(visitor, eventid);
				} catch (ClassNotFoundException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} catch (SQLException e) {
		...
		return check; // replace "false" with the "status" variable used in the code in 'TODO' section
	}
